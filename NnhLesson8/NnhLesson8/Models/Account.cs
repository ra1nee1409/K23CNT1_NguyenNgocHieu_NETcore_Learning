...
namespace NnhLesson8.Models
{
    public class Account
    {
        ...
        [Remote(action:"VerifyPhone", controller:"NnhAccount")]           
        ...
        [Url(ErrorMessage = "Url phải đúng định dạng bao gồm http hoặc https, tên miền VD: https://facebook.com/idfbcuaban")]
